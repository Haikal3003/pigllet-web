...
export default function Footer() {
  return (
    <footer className="w-full  pt-14 border-t border-t-slate-200">
      <div className="flex justify-between gap-8 px-36 max-md:px-6 max-md:flex-col">
        <div>
          ...
          <div>
            ...
            <div className="flex w-[400px] max-md:w-full items-center space-x-2 p-2 max-md:p-1 rounded-full border border-slate-300 ">
      ...
      <div className="flex items-center justify-between mt-8 border-t py-4 px-36 max-md:px-6 max-sm:text-xs border-gray-200  text-center text-gray-500 text-sm">
